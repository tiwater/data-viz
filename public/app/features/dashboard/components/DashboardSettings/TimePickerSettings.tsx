...
export class TimePickerSettings extends PureComponent<Props, State> {
  ...
  render() {
    return (
      <CollapsableSection label={t('features.dashboard.setting.time-options', 'Time options')} isOpen={true}>
        <Field
          label={t('features.dashboard.setting.time-zone', 'Time zone')}
        ...
        <Field
          label={t('features.dashboard.setting.week-start', 'Week start')}
        ...
        <Field label={t('features.dashboard.setting.hide-time-picker', 'Hide time picker')}>
          <Switch
